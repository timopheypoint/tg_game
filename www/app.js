...
class Game {
    constructor() {
        ...
        // Load textures first
        Promise.all([
            this.assets.loadTexture('grass', 'grass.jpg'),
            this.assets.loadTexture('brick', 'brick.jpg'),
            this.assets.loadTexture('road', 'road.jpg')
        ]).then(() => {
            this.world = new World(this.scene, this.physicsWorld.world, this.assets);
        });
